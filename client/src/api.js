...
export const questionRemove = post("/api/question/remove");
...
export const subjectUpdate = post("/api/subject/update");
export const subjectRemove = post("/api/subject/remove");
export const topicCreate = post("/api/topic/create");
export const topicUpdate = post("/api/topic/update");
export const topicRemove = post("/api/topic/remove");
